...
export interface Property {
  ...
  export const properties: Property[] = [
    {
      id: 1,
      image: 'https://github.com/jpcardozx/re-agency/blob/main/src/assets/h1a.jpg?raw=true',
    ...
    {
      id: 2,
      image: 'https://github.com/jpcardozx/re-agency/blob/main/src/assets/h2a.jpg?raw=true',
